  ...
  V(FIRST_HEAP_OBJECT_TYPE, 0) \
    ...
    V(FIRST_JS_RECEIVER_TYPE, 266) \
      ...
      V(FIRST_JS_OBJECT_TYPE, 269) \
        ...
        V(JS_CONTEXT_EXTENSION_OBJECT_TYPE, 2107) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/builtins/base.tq?l=593&c=1 */\
        V(JS_DATE_TYPE, 2108) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/js-objects.tq?l=138&c=1 */\
        V(JS_ERROR_TYPE, 2109) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/builtins/base.tq?l=595&c=1 */\
        V(JS_EXTERNAL_OBJECT_TYPE, 2110) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/js-objects.tq?l=43&c=1 */\
        V(JS_FINALIZATION_REGISTRY_TYPE, 2111) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/js-weak-refs.tq?l=9&c=1 */\
        V(JS_MESSAGE_OBJECT_TYPE, 2112) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/js-objects.tq?l=119&c=1 */\
        V(JS_REG_EXP_TYPE, 2113) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/js-regexp.tq?l=16&c=1 */\
        V(JS_REG_EXP_STRING_ITERATOR_TYPE, 2114) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/js-regexp-string-iterator.tq?l=11&c=1 */\
        V(JS_SHADOW_REALM_TYPE, 2115) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/js-shadow-realms.tq?l=5&c=1 */\
        V(JS_SHARED_STRUCT_TYPE, 2116) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/js-struct.tq?l=5&c=1 */\
        V(JS_STRING_ITERATOR_TYPE, 2117) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/js-objects.tq?l=165&c=1 */\
        V(JS_TEMPORAL_CALENDAR_TYPE, 2118) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/js-temporal-objects.tq?l=37&c=1 */\
        V(JS_TEMPORAL_DURATION_TYPE, 2119) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/js-temporal-objects.tq?l=41&c=1 */\
        V(JS_TEMPORAL_INSTANT_TYPE, 2120) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/js-temporal-objects.tq?l=54&c=1 */\
        V(JS_TEMPORAL_PLAIN_DATE_TYPE, 2121) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/js-temporal-objects.tq?l=63&c=1 */\
        V(JS_TEMPORAL_PLAIN_DATE_TIME_TYPE, 2122) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/js-temporal-objects.tq?l=56&c=1 */\
        V(JS_TEMPORAL_PLAIN_MONTH_DAY_TYPE, 2123) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/js-temporal-objects.tq?l=68&c=1 */\
        V(JS_TEMPORAL_PLAIN_TIME_TYPE, 2124) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/js-temporal-objects.tq?l=73&c=1 */\
        V(JS_TEMPORAL_PLAIN_YEAR_MONTH_TYPE, 2125) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/js-temporal-objects.tq?l=79&c=1 */\
        V(JS_TEMPORAL_TIME_ZONE_TYPE, 2126) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/js-temporal-objects.tq?l=84&c=1 */\
        V(JS_TEMPORAL_ZONED_DATE_TIME_TYPE, 2127) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/js-temporal-objects.tq?l=89&c=1 */\
        V(JS_WEAK_REF_TYPE, 2128) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/js-weak-refs.tq?l=42&c=1 */\
        V(WASM_GLOBAL_OBJECT_TYPE, 2129) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/wasm/wasm-objects.tq?l=144&c=1 */\
        V(WASM_INSTANCE_OBJECT_TYPE, 2130) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/wasm/wasm-objects.tq?l=12&c=1 */\
        V(WASM_MEMORY_OBJECT_TYPE, 2131) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/wasm/wasm-objects.tq?l=138&c=1 */\
        V(WASM_MODULE_OBJECT_TYPE, 2132) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/wasm/wasm-objects.tq?l=117&c=1 */\
        V(WASM_SUSPENDER_OBJECT_TYPE, 2133) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/wasm/wasm-objects.tq?l=103&c=1 */\
        V(WASM_TABLE_OBJECT_TYPE, 2134) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/wasm/wasm-objects.tq?l=123&c=1 */\
        V(WASM_TAG_OBJECT_TYPE, 2135) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/wasm/wasm-objects.tq?l=159&c=1 */\
        V(WASM_VALUE_OBJECT_TYPE, 2136) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/debug/debug-wasm-objects.tq?l=7&c=1 */\
      V(LAST_JS_OBJECT_TYPE, 2136) \
    V(LAST_JS_RECEIVER_TYPE, 2136) \
  V(LAST_HEAP_OBJECT_TYPE, 2136) \
