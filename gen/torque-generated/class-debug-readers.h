...
class TqWasmInternalFunction : public TqForeign {
 public:
  inline TqWasmInternalFunction(uintptr_t address) : TqForeign(address) {}
  std::vector<std::unique_ptr<ObjectProperty>> GetProperties(
      d::MemoryAccessor accessor) const override;
  const char* GetName() const override;
  void Visit(TqObjectVisitor* visitor) const override;
...
class TqJSArrayBufferView : public TqJSObjectWithEmbedderSlots {
 public:
  inline TqJSArrayBufferView(uintptr_t address) : TqJSObjectWithEmbedderSlots(address) {}
  std::vector<std::unique_ptr<ObjectProperty>> GetProperties(
      d::MemoryAccessor accessor) const override;
  const char* GetName() const override;
  void Visit(TqObjectVisitor* visitor) const override;
...
class TqBytecodeArray : public TqFixedArrayBase {
 public:
  ...
  uintptr_t GetOsrUrgencyAndInstallTargetAddress() const;
  Value<uint16_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> GetOsrUrgencyAndInstallTargetValue(d::MemoryAccessor accessor ) const;
...
class TqPromiseOnStack : public TqStruct {
 public:
  inline TqPromiseOnStack(uintptr_t address) : TqStruct(address) {}
  std::vector<std::unique_ptr<ObjectProperty>> GetProperties(
      d::MemoryAccessor accessor) const override;
  const char* GetName() const override;
  void Visit(TqObjectVisitor* visitor) const override;
...
class TqJSArrayBuffer : public TqJSObjectWithEmbedderSlots {
 public:
  inline TqJSArrayBuffer(uintptr_t address) : TqJSObjectWithEmbedderSlots(address) {}
  std::vector<std::unique_ptr<ObjectProperty>> GetProperties(
      d::MemoryAccessor accessor) const override;
  const char* GetName() const override;
  void Visit(TqObjectVisitor* visitor) const override;
...
class TqJSSharedStruct : public TqJSObject {
 public:
  inline TqJSSharedStruct(uintptr_t address) : TqJSObject(address) {}
  std::vector<std::unique_ptr<ObjectProperty>> GetProperties(
      d::MemoryAccessor accessor) const override;
  const char* GetName() const override;
  void Visit(TqObjectVisitor* visitor) const override;
...
class TqScript : public TqStruct {
 public:
  ...
  uintptr_t GetHostDefinedOptionsAddress() const;
  Value<uintptr_t> GetHostDefinedOptionsValue(d::MemoryAccessor accessor ) const;
  uintptr_t GetScriptOrModulesAddress() const;
  Value<uintptr_t> GetScriptOrModulesValue(d::MemoryAccessor accessor ) const;
};
...
class TqWasmApiFunctionRef : public TqHeapObject {
 public:
  ...
  void Visit(TqObjectVisitor* visitor) const override;
  bool IsSuperclassOf(const TqObject* other) const override;
  uintptr_t GetIsolateRootAddress() const;
  Value<Address /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> GetIsolateRootValue(d::MemoryAccessor accessor ) const;
  uintptr_t GetNativeContextAddress() const;
  Value<uintptr_t> GetNativeContextValue(d::MemoryAccessor accessor ) const;
  uintptr_t GetCallableAddress() const;
  Value<uintptr_t> GetCallableValue(d::MemoryAccessor accessor ) const;
...
class TqWasmFunctionData : public TqHeapObject {
 public:
  inline TqWasmFunctionData(uintptr_t address) : TqHeapObject(address) {}
  std::vector<std::unique_ptr<ObjectProperty>> GetProperties(
      d::MemoryAccessor accessor) const override;
  const char* GetName() const override;
  void Visit(TqObjectVisitor* visitor) const override;
...
class TqWasmOnFulfilledData : public TqHeapObject {
 public:
  inline TqWasmOnFulfilledData(uintptr_t address) : TqHeapObject(address) {}
  std::vector<std::unique_ptr<ObjectProperty>> GetProperties(
      d::MemoryAccessor accessor) const override;
  const char* GetName() const override;
  void Visit(TqObjectVisitor* visitor) const override;
...
class TqWasmContinuationObject : public TqStruct {
 public:
  inline TqWasmContinuationObject(uintptr_t address) : TqStruct(address) {}
  std::vector<std::unique_ptr<ObjectProperty>> GetProperties(
      d::MemoryAccessor accessor) const override;
  const char* GetName() const override;
  void Visit(TqObjectVisitor* visitor) const override;
  ...
  Value<uintptr_t> GetJmpbufValue(d::MemoryAccessor accessor ) const;
  uintptr_t GetParentAddress() const;
  Value<uintptr_t> GetParentValue(d::MemoryAccessor accessor ) const;
};

class TqWasmSuspenderObject : public TqJSObject {
 public:
  inline TqWasmSuspenderObject(uintptr_t address) : TqJSObject(address) {}
  std::vector<std::unique_ptr<ObjectProperty>> GetProperties(
      d::MemoryAccessor accessor) const override;
  const char* GetName() const override;
  void Visit(TqObjectVisitor* visitor) const override;
...
class TqObjectVisitor {
 public:
  ...
  virtual void VisitPromiseOnStack(const TqPromiseOnStack* object) {
    VisitStruct(object);
  }
  ...
  virtual void VisitWasmOnFulfilledData(const TqWasmOnFulfilledData* object) {
    VisitHeapObject(object);
  }
