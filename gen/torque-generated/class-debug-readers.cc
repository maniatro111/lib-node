...
uintptr_t TqBytecodeArray::GetOsrUrgencyAndInstallTargetAddress() const {
  return address_ - i::kHeapObjectTag + 52;
}

Value<uint16_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> TqBytecodeArray::GetOsrUrgencyAndInstallTargetValue(d::MemoryAccessor accessor) const {
  uint16_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value{};
  d::MemoryAccessResult validity = accessor(GetOsrUrgencyAndInstallTargetAddress(), reinterpret_cast<uint8_t*>(&value), sizeof(value));
  return {validity, value};
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqBytecodeArray::GetProperties(d::MemoryAccessor accessor) const {
  ...
  std::vector<std::unique_ptr<StructProperty>> osr_urgency_and_install_target_struct_field_list;
  osr_urgency_and_install_target_struct_field_list.push_back(std::make_unique<StructProperty>("osr_urgency", CheckTypeName<uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("uint32_t"), CheckTypeName<uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("uint32_t"), 0, 3, 0));
  osr_urgency_and_install_target_struct_field_list.push_back(std::make_unique<StructProperty>("osr_install_target", CheckTypeName<uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("uint32_t"), CheckTypeName<uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("uint32_t"), 0, 13, 3));
  result.push_back(std::make_unique<ObjectProperty>("osr_urgency_and_install_target", CheckTypeName<uint16_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("uint16_t"), CheckTypeName<uint16_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("uint16_t"), GetOsrUrgencyAndInstallTargetAddress(), 1, 2, std::move(osr_urgency_and_install_target_struct_field_list), d::PropertyKind::kSingle));
...
std::vector<std::unique_ptr<ObjectProperty>> TqFeedbackVector::GetProperties(d::MemoryAccessor accessor) const {
  ...
  flags_struct_field_list.push_back(std::make_unique<StructProperty>("maybe_has_optimized_code", CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 3));
  flags_struct_field_list.push_back(std::make_unique<StructProperty>("osr_tiering_state", CheckTypeName<TieringState /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("TieringState"), CheckTypeName<TieringState /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("TieringState"), 0, 1, 4));
  flags_struct_field_list.push_back(std::make_unique<StructProperty>("all_your_bits_are_belong_to_jgruber", CheckTypeName<uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("uint32_t"), CheckTypeName<uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("uint32_t"), 0, 27, 5));
  result.push_back(std::make_unique<ObjectProperty>("flags", CheckTypeName<uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("uint32_t"), CheckTypeName<uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("uint32_t"), GetFlagsAddress(), 1, 4, std::move(flags_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> shared_function_info_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("shared_function_info", "v8::internal::SharedFunctionInfo", "v8::internal::SharedFunctionInfo", GetSharedFunctionInfoAddress(), 1, 8, std::move(shared_function_info_struct_field_list), d::PropertyKind::kSingle));
...
Value<Address /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> TqJSDataView::GetDataPointerValue(d::MemoryAccessor accessor) const {
  Address /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value{};
...
uintptr_t TqScript::GetScriptOrModulesAddress() const {
  return address_ - i::kHeapObjectTag + 128;
}

Value<uintptr_t> TqScript::GetScriptOrModulesValue(d::MemoryAccessor accessor) const {
  i::Tagged_t value{};
  d::MemoryAccessResult validity = accessor(GetScriptOrModulesAddress(), reinterpret_cast<uint8_t*>(&value), sizeof(value));
  return {validity, EnsureDecompressed(value, address_)};
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqScript::GetProperties(d::MemoryAccessor accessor) const {
  ...
  std::vector<std::unique_ptr<StructProperty>> host_defined_options_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("host_defined_options", "v8::internal::FixedArray", "v8::internal::FixedArray", GetHostDefinedOptionsAddress(), 1, 8, std::move(host_defined_options_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> script_or_modules_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("script_or_modules", "v8::internal::ArrayList", "v8::internal::ArrayList", GetScriptOrModulesAddress(), 1, 8, std::move(script_or_modules_struct_field_list), d::PropertyKind::kSingle));
  return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqSharedFunctionInfo::GetProperties(d::MemoryAccessor accessor) const {
  ...
  flags2_struct_field_list.push_back(std::make_unique<StructProperty>("maglev_compilation_failed", CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 2));
  ...
  flags_struct_field_list.push_back(std::make_unique<StructProperty>("osr_code_cache_state", CheckTypeName<OSRCodeCacheStateOfSFI /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("OSRCodeCacheStateOfSFI"), CheckTypeName<OSRCodeCacheStateOfSFI /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("OSRCodeCacheStateOfSFI"), 0, 2, 30));
  result.push_back(std::make_unique<ObjectProperty>("flags", CheckTypeName<uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("uint32_t"), CheckTypeName<uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("uint32_t"), GetFlagsAddress(), 1, 4, std::move(flags_struct_field_list), d::PropertyKind::kSingle));
...
uintptr_t TqWasmApiFunctionRef::GetIsolateRootAddress() const {
  return address_ - i::kHeapObjectTag + 8;
}

Value<Address /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> TqWasmApiFunctionRef::GetIsolateRootValue(d::MemoryAccessor accessor) const {
  Address /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value{};
  d::MemoryAccessResult validity = accessor(GetIsolateRootAddress(), reinterpret_cast<uint8_t*>(&value), sizeof(value));
  return {validity, value};
}
...
uintptr_t TqWasmApiFunctionRef::GetSuspenderAddress() const {
  return address_ - i::kHeapObjectTag + 32;
}

Value<uintptr_t> TqWasmApiFunctionRef::GetSuspenderValue(d::MemoryAccessor accessor) const {
  i::Tagged_t value{};
...
std::vector<std::unique_ptr<ObjectProperty>> TqWasmApiFunctionRef::GetProperties(d::MemoryAccessor accessor) const {
  std::vector<std::unique_ptr<ObjectProperty>> result = TqHeapObject::GetProperties(accessor);
  std::vector<std::unique_ptr<StructProperty>> isolate_root_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("isolate_root", CheckTypeName<Address /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("Address"), CheckTypeName<Address /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("Address"), GetIsolateRootAddress(), 1, 8, std::move(isolate_root_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> native_context_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("native_context", "v8::internal::NativeContext", "v8::internal::NativeContext", GetNativeContextAddress(), 1, 8, std::move(native_context_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> callable_struct_field_list;
  ...
  result.push_back(std::make_unique<ObjectProperty>("suspender", "v8::internal::HeapObject", "v8::internal::HeapObject", GetSuspenderAddress(), 1, 8, std::move(suspender_struct_field_list), d::PropertyKind::kSingle));
  return result;
}
...
uintptr_t TqWasmExportedFunctionData::GetSuspenderAddress() const {
  return address_ - i::kHeapObjectTag + 72;
}

Value<uintptr_t> TqWasmExportedFunctionData::GetSuspenderValue(d::MemoryAccessor accessor) const {
  i::Tagged_t value{};
  d::MemoryAccessResult validity = accessor(GetSuspenderAddress(), reinterpret_cast<uint8_t*>(&value), sizeof(value));
  return {validity, EnsureDecompressed(value, address_)};
}
...
const char* TqWasmOnFulfilledData::GetName() const {
  return "v8::internal::WasmOnFulfilledData";
}

void TqWasmOnFulfilledData::Visit(TqObjectVisitor* visitor) const {
  visitor->VisitWasmOnFulfilledData(this);
}

bool TqWasmOnFulfilledData::IsSuperclassOf(const TqObject* other) const {
  return GetName() != other->GetName() && dynamic_cast<const TqWasmOnFulfilledData*>(other) != nullptr;
}

uintptr_t TqWasmOnFulfilledData::GetSuspenderAddress() const {
  return address_ - i::kHeapObjectTag + 8;
}

Value<uintptr_t> TqWasmOnFulfilledData::GetSuspenderValue(d::MemoryAccessor accessor) const {
  i::Tagged_t value{};
  d::MemoryAccessResult validity = accessor(GetSuspenderAddress(), reinterpret_cast<uint8_t*>(&value), sizeof(value));
  return {validity, EnsureDecompressed(value, address_)};
}

std::vector<std::unique_ptr<ObjectProperty>> TqWasmOnFulfilledData::GetProperties(d::MemoryAccessor accessor) const {
  std::vector<std::unique_ptr<ObjectProperty>> result = TqHeapObject::GetProperties(accessor);
  std::vector<std::unique_ptr<StructProperty>> suspender_struct_field_list;
...
Value<uintptr_t> TqWasmContinuationObject::GetJmpbufValue(d::MemoryAccessor accessor) const {
  i::Tagged_t value{};
...
std::vector<std::unique_ptr<ObjectProperty>> TqWasmContinuationObject::GetProperties(d::MemoryAccessor accessor) const {
  ...
  result.push_back(std::make_unique<ObjectProperty>("jmpbuf", "v8::internal::Foreign", "v8::internal::Foreign", GetJmpbufAddress(), 1, 8, std::move(jmpbuf_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> parent_struct_field_list;
...
std::vector<std::unique_ptr<ObjectProperty>> TqWasmSuspenderObject::GetProperties(d::MemoryAccessor accessor) const {
  ...
  result.push_back(std::make_unique<ObjectProperty>("resume", "v8::internal::JSObject", "v8::internal::JSObject", GetResumeAddress(), 1, 8, std::move(resume_struct_field_list), d::PropertyKind::kSingle));
...
const char* kObjectClassNames[] {
  ...
  "v8::internal::WasmOnFulfilledData",
