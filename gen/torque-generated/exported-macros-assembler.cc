...
// https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/ordered-hash-table.tq?l=105&c=28
...
TNode<ArrayList> TorqueGeneratedExportedMacrosAssembler::LoadScriptScriptOrModules(TNode<Script> p_o) {
return LoadScriptScriptOrModules_0(state_, p_o);}

// https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/script.tq?l=66&c=42
void TorqueGeneratedExportedMacrosAssembler::StoreScriptScriptOrModules(TNode<Script> p_o, TNode<ArrayList> p_v) {
return StoreScriptScriptOrModules_0(state_, p_o, p_v);}
