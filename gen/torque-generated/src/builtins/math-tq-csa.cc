...
TF_BUILTIN(MathHypot, CodeStubAssembler) {
  ...
  if (block27.is_used()) {
    ...
    tmp37 = FromConstexpr_float64_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x0ull));
    tmp38 = FromConstexpr_intptr_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x0ull));
    ca_.Goto(&block34, phi_bb27_8, phi_bb27_9, tmp36, tmp37, tmp38);
  }
  ...
  if (block34.is_used()) {
    ...
    tmp39 = CodeStubAssembler(state_).IntPtrLessThan(TNode<IntPtrT>{phi_bb34_12}, TNode<IntPtrT>{torque_arguments.length});
    ca_.Branch(tmp39, &block32, std::vector<compiler::Node*>{phi_bb34_8, phi_bb34_9, phi_bb34_10, phi_bb34_11, phi_bb34_12}, &block33, std::vector<compiler::Node*>{phi_bb34_8, phi_bb34_9, phi_bb34_10, phi_bb34_11, phi_bb34_12});
  }
  ...
  if (block32.is_used()) {
    ...
    tmp43 = Convert_uintptr_intptr_0(state_, TNode<IntPtrT>{phi_bb32_12});
    ...
    ca_.Branch(tmp45, &block40, std::vector<compiler::Node*>{phi_bb32_8, phi_bb32_9, phi_bb32_10, phi_bb32_11, phi_bb32_12, phi_bb32_12, phi_bb32_12, phi_bb32_12, phi_bb32_12}, &block41, std::vector<compiler::Node*>{phi_bb32_8, phi_bb32_9, phi_bb32_10, phi_bb32_11, phi_bb32_12, phi_bb32_12, phi_bb32_12, phi_bb32_12, phi_bb32_12});
  }
  ...
  if (block40.is_used()) {
    ...
    tmp46 = TimesSizeOf_float64_or_hole_0(state_, TNode<IntPtrT>{phi_bb40_23});
    ...
    tmp52 = CodeStubAssembler(state_).Float64Div(TNode<Float64T>{tmp51}, TNode<Float64T>{phi_bb40_9});
    tmp53 = CodeStubAssembler(state_).Float64Mul(TNode<Float64T>{tmp52}, TNode<Float64T>{tmp52});
    tmp54 = CodeStubAssembler(state_).Float64Sub(TNode<Float64T>{tmp53}, TNode<Float64T>{phi_bb40_11});
    tmp55 = CodeStubAssembler(state_).Float64Add(TNode<Float64T>{phi_bb40_10}, TNode<Float64T>{tmp54});
    tmp56 = CodeStubAssembler(state_).Float64Sub(TNode<Float64T>{tmp55}, TNode<Float64T>{phi_bb40_10});
    ...
    tmp59 = CodeStubAssembler(state_).IntPtrAdd(TNode<IntPtrT>{phi_bb40_12}, TNode<IntPtrT>{tmp58});
    ca_.Goto(&block34, phi_bb40_8, phi_bb40_9, tmp55, tmp57, tmp59);
  }
  ...
  if (block33.is_used()) {
    ...
    tmp60 = CodeStubAssembler(state_).Float64Sqrt(TNode<Float64T>{phi_bb33_10});
    tmp61 = CodeStubAssembler(state_).Float64Mul(TNode<Float64T>{tmp60}, TNode<Float64T>{phi_bb33_9});
