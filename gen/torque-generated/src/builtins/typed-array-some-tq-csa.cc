...
TF_BUILTIN(TypedArrayPrototypeSome, CodeStubAssembler) {
  ...
  if (block11.is_used()) {
    ...
    tmp13 = SomeAllElements_0(state_, TNode<Context>{parameter0}, TorqueStructAttachedJSTypedArrayAndLength_0{TNode<JSTypedArray>{tmp2}, TNode<UintPtrT>{tmp3}}, TNode<JSReceiver>{tmp7}, TNode<Object>{tmp12});
