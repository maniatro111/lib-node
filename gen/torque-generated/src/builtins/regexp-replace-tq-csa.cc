...
void RegExpReplaceCallableNoExplicitCaptures_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<FixedArray> p_matchesElements, TNode<IntPtrT> p_matchesLength, TNode<String> p_string, TNode<JSReceiver> p_replaceFn) {
  ...
  if (block31.is_used()) {
    ...
    tmp43 = CodeStubAssembler(state_).Call(TNode<Context>{p_context}, TNode<Object>{p_replaceFn}, TNode<Object>{tmp42}, TNode<Object>{tmp16}, TNode<Object>{phi_bb31_5}, TNode<Object>{p_string});
    ...
    tmp48 = Convert_uintptr_intptr_0(state_, TNode<IntPtrT>{phi_bb31_6});
    ...
    ca_.Branch(tmp50, &block37, std::vector<compiler::Node*>{phi_bb31_5, phi_bb31_6, phi_bb31_6, phi_bb31_6, phi_bb31_6, phi_bb31_6}, &block38, std::vector<compiler::Node*>{phi_bb31_5, phi_bb31_6, phi_bb31_6, phi_bb31_6, phi_bb31_6, phi_bb31_6});
  }
  ...
  if (block37.is_used()) {
    ...
    tmp51 = TimesSizeOf_Object_0(state_, TNode<IntPtrT>{phi_bb37_21});
    ...
    tmp56 = CodeStubAssembler(state_).SmiAdd(TNode<Smi>{phi_bb37_5}, TNode<Smi>{tmp55});
    ca_.Goto(&block14, tmp56, phi_bb37_6);
  }
  ...
  if (block14.is_used()) {
    ...
    tmp58 = CodeStubAssembler(state_).IntPtrAdd(TNode<IntPtrT>{phi_bb14_6}, TNode<IntPtrT>{tmp57});
    ca_.Goto(&block4, phi_bb14_5, tmp58);
  }
...
void RegExpReplaceCallableWithExplicitCaptures_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<FixedArray> p_matchesElements, TNode<IntPtrT> p_matchesLength, TNode<JSReceiver> p_replaceFn) {
  ...
  if (block16.is_used()) {
    ...
    tmp22 = Convert_uintptr_intptr_0(state_, TNode<IntPtrT>{phi_bb16_4});
    ...
    ca_.Branch(tmp24, &block22, std::vector<compiler::Node*>{phi_bb16_4, phi_bb16_4, phi_bb16_4, phi_bb16_4, phi_bb16_4}, &block23, std::vector<compiler::Node*>{phi_bb16_4, phi_bb16_4, phi_bb16_4, phi_bb16_4, phi_bb16_4});
  }
  ...
  if (block22.is_used()) {
    ...
    tmp25 = TimesSizeOf_Object_0(state_, TNode<IntPtrT>{phi_bb22_17});
  ...
  if (block23.is_used()) {
    ca_.Bind(&block23, &phi_bb23_4, &phi_bb23_11, &phi_bb23_12, &phi_bb23_16, &phi_bb23_17);
    CodeStubAssembler(state_).Unreachable();
  }
...
TNode<String> RegExpReplaceFastGlobalCallable_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSRegExp> p_regexp, TNode<String> p_string, TNode<JSReceiver> p_replaceFn) {
  ...
  if (block0.is_used()) {
    ...
    tmp1 = FromConstexpr_intptr_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x10ull));
  ...
  if (block6.is_used()) {
    ...
    tmp21 = FromConstexpr_Smi_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x2ull));
...
TNode<String> RegExpReplaceFastString_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSRegExp> p_regexp, TNode<String> p_string, TNode<String> p_replaceString) {
  ...
  if (block9.is_used()) {
    ...
    tmp11 = Method_RegExpMatchInfo_GetStartOfCapture_0(state_, TNode<Context>{p_context}, TNode<RegExpMatchInfo>{tmp9}, (FromConstexpr_constexpr_int31_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x0ull))));
    tmp12 = Method_RegExpMatchInfo_GetEndOfCapture_0(state_, TNode<Context>{p_context}, TNode<RegExpMatchInfo>{tmp9}, (FromConstexpr_constexpr_int31_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x0ull))));
