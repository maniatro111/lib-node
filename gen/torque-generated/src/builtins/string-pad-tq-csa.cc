...
TNode<String> StringPad_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Object> p_receiver, TorqueStructArguments p_arguments, const char* p_methodName, int31_t p_variant) {
  ...
  if (block17.is_used()) {
    ...
    ca_.Goto(&block15, phi_bb17_9, phi_bb17_10);
  }
  ...
  if (block15.is_used()) {
    ...
    ca_.Branch(tmp24, &block24, std::vector<compiler::Node*>{phi_bb15_9, phi_bb15_10}, &block25, std::vector<compiler::Node*>{phi_bb15_9, phi_bb15_10});
  }
  ...
  if (block25.is_used()) {
    ...
    ca_.Branch(tmp27, &block26, std::vector<compiler::Node*>{phi_bb25_9, phi_bb25_10}, &block27, std::vector<compiler::Node*>{phi_bb25_9, phi_bb25_10});
  }
  ...
  if (block27.is_used()) {
    ...
    tmp30 = CodeStubAssembler(state_).WordEqual(TNode<IntPtrT>{phi_bb27_10}, TNode<IntPtrT>{tmp29});
    ca_.Branch(tmp30, &block32, std::vector<compiler::Node*>{phi_bb27_9, phi_bb27_10}, &block33, std::vector<compiler::Node*>{phi_bb27_9, phi_bb27_10});
  }
  ...
  if (block33.is_used()) {
    ...
    tmp32 = CodeStubAssembler(state_).TruncateIntPtrToInt32(TNode<IntPtrT>{phi_bb33_10});
  ...
  if (block36.is_used()) {
    ...
    ca_.Goto(&block34, phi_bb36_9, phi_bb36_10, phi_bb36_13);
  }
  ...
  if (block34.is_used()) {
    ...
    ca_.Branch(tmp44, &block41, std::vector<compiler::Node*>{phi_bb34_9, phi_bb34_10, phi_bb34_13}, &block42, std::vector<compiler::Node*>{phi_bb34_9, phi_bb34_10, phi_bb34_13});
  }

  TNode<String> phi_bb41_9;
  TNode<IntPtrT> phi_bb41_10;
  TNode<String> phi_bb41_13;
  TNode<String> tmp45;
  if (block41.is_used()) {
    ca_.Bind(&block41, &phi_bb41_9, &phi_bb41_10, &phi_bb41_13);
    tmp45 = StringAdd_0(state_, TNode<Context>{p_context}, TNode<String>{phi_bb41_13}, TNode<String>{tmp1});
    ca_.Goto(&block1, tmp45);
  }

  TNode<String> phi_bb42_9;
  TNode<IntPtrT> phi_bb42_10;
  TNode<String> phi_bb42_13;
  TNode<String> tmp46;
  if (block42.is_used()) {
    ca_.Bind(&block42, &phi_bb42_9, &phi_bb42_10, &phi_bb42_13);
    tmp46 = StringAdd_0(state_, TNode<Context>{p_context}, TNode<String>{tmp1}, TNode<String>{phi_bb42_13});
  ...
  if (block1.is_used()) {
    ...
    ca_.Goto(&block47, phi_bb1_6);
  }

  TNode<String> phi_bb47_6;
    ca_.Bind(&block47, &phi_bb47_6);
  return TNode<String>{phi_bb47_6};
}
