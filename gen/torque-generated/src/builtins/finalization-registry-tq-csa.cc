...
TF_BUILTIN(FinalizationRegistryRegister, CodeStubAssembler) {
  ...
  if (block11.is_used()) {
    ...
    CodeStubAssembler(state_).StoreReference<HeapObject>(CodeStubAssembler::Reference{tmp24, tmp28}, phi_bb11_10);
    ...
    tmp36 = CodeStubAssembler(state_).TaggedNotEqual(TNode<HeapObject>{phi_bb11_10}, TNode<HeapObject>{tmp35});
