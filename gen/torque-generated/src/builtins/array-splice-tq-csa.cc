...
TNode<Object> FastArraySplice_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TorqueStructArguments p_args, TNode<JSReceiver> p_o, TNode<Number> p_originalLengthNumber, TNode<Number> p_actualStartNumber, TNode<Smi> p_insertCount, TNode<Number> p_actualDeleteCountNumber, compiler::CodeAssemblerLabel* label_Bailout) {
  ...
  if (block20.is_used()) {
    ca_.Bind(&block20);
    tmp20 = FromConstexpr_intptr_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x2ull));
    ca_.Goto(&block23, tmp16, tmp20);
  }

  TNode<Int32T> phi_bb23_17;
  TNode<IntPtrT> phi_bb23_19;
  TNode<BoolT> tmp21;
  if (block23.is_used()) {
    ca_.Bind(&block23, &phi_bb23_17, &phi_bb23_19);
    tmp21 = CodeStubAssembler(state_).IntPtrLessThan(TNode<IntPtrT>{phi_bb23_19}, TNode<IntPtrT>{p_args.length});
    ca_.Branch(tmp21, &block21, std::vector<compiler::Node*>{phi_bb23_17, phi_bb23_19}, &block22, std::vector<compiler::Node*>{phi_bb23_17, phi_bb23_19});
  }

  TNode<Int32T> phi_bb21_17;
  TNode<IntPtrT> phi_bb21_19;
  TNode<Object> tmp22;
  TNode<BoolT> tmp23;
  if (block21.is_used()) {
    ca_.Bind(&block21, &phi_bb21_17, &phi_bb21_19);
    tmp22 = CodeStubAssembler(state_).GetArgumentValue(TorqueStructArguments{TNode<RawPtrT>{p_args.frame}, TNode<RawPtrT>{p_args.base}, TNode<IntPtrT>{p_args.length}, TNode<IntPtrT>{p_args.actual_count}}, TNode<IntPtrT>{phi_bb21_19});
    tmp23 = CodeStubAssembler(state_).IsFastSmiElementsKind(TNode<Int32T>{phi_bb21_17});
    ca_.Branch(tmp23, &block25, std::vector<compiler::Node*>{phi_bb21_17, phi_bb21_19}, &block26, std::vector<compiler::Node*>{phi_bb21_17, phi_bb21_19});
  }

  TNode<Int32T> phi_bb25_17;
  TNode<IntPtrT> phi_bb25_19;
  TNode<BoolT> tmp24;
  if (block25.is_used()) {
    ca_.Bind(&block25, &phi_bb25_17, &phi_bb25_19);
    tmp24 = CodeStubAssembler(state_).TaggedIsNotSmi(TNode<Object>{tmp22});
    ca_.Branch(tmp24, &block28, std::vector<compiler::Node*>{phi_bb25_17, phi_bb25_19}, &block29, std::vector<compiler::Node*>{phi_bb25_17, phi_bb25_19});
  }

  TNode<Int32T> phi_bb28_17;
  TNode<IntPtrT> phi_bb28_19;
  TNode<HeapObject> tmp25;
  TNode<BoolT> tmp26;
  if (block28.is_used()) {
    ca_.Bind(&block28, &phi_bb28_17, &phi_bb28_19);
    ...
    ca_.Branch(tmp26, &block30, std::vector<compiler::Node*>{phi_bb28_17, phi_bb28_19}, &block31, std::vector<compiler::Node*>{phi_bb28_17, phi_bb28_19});
  }

  TNode<Int32T> phi_bb30_17;
  TNode<IntPtrT> phi_bb30_19;
  TNode<Int32T> tmp27;
  if (block30.is_used()) {
    ca_.Bind(&block30, &phi_bb30_17, &phi_bb30_19);
    tmp27 = AllowDoubleElements_0(state_, TNode<Int32T>{phi_bb30_17});
    ca_.Goto(&block32, phi_bb30_17, phi_bb30_19, tmp27);
  }

  TNode<Int32T> phi_bb31_17;
  TNode<IntPtrT> phi_bb31_19;
  TNode<Int32T> tmp28;
  if (block31.is_used()) {
    ca_.Bind(&block31, &phi_bb31_17, &phi_bb31_19);
    tmp28 = AllowNonNumberElements_0(state_, TNode<Int32T>{phi_bb31_17});
    ca_.Goto(&block32, phi_bb31_17, phi_bb31_19, tmp28);
  }

  TNode<Int32T> phi_bb32_17;
  TNode<IntPtrT> phi_bb32_19;
  TNode<Int32T> phi_bb32_22;
  if (block32.is_used()) {
    ca_.Bind(&block32, &phi_bb32_17, &phi_bb32_19, &phi_bb32_22);
    ca_.Goto(&block29, phi_bb32_22, phi_bb32_19);
  }

  TNode<Int32T> phi_bb29_17;
  TNode<IntPtrT> phi_bb29_19;
  if (block29.is_used()) {
    ca_.Bind(&block29, &phi_bb29_17, &phi_bb29_19);
    ca_.Goto(&block27, phi_bb29_17, phi_bb29_19);
  }

  TNode<Int32T> phi_bb26_17;
  TNode<IntPtrT> phi_bb26_19;
  TNode<BoolT> tmp29;
  if (block26.is_used()) {
    ca_.Bind(&block26, &phi_bb26_17, &phi_bb26_19);
    tmp29 = CodeStubAssembler(state_).IsDoubleElementsKind(TNode<Int32T>{phi_bb26_17});
    ca_.Branch(tmp29, &block34, std::vector<compiler::Node*>{phi_bb26_17, phi_bb26_19}, &block35, std::vector<compiler::Node*>{phi_bb26_17, phi_bb26_19});
  }

  TNode<Int32T> phi_bb34_17;
  TNode<IntPtrT> phi_bb34_19;
  TNode<BoolT> tmp30;
  TNode<BoolT> tmp31;
  if (block34.is_used()) {
    ca_.Bind(&block34, &phi_bb34_17, &phi_bb34_19);
    tmp30 = IsNumber_0(state_, TNode<Object>{tmp22});
    tmp31 = CodeStubAssembler(state_).Word32BinaryNot(TNode<BoolT>{tmp30});
    ca_.Branch(tmp31, &block36, std::vector<compiler::Node*>{phi_bb34_17, phi_bb34_19}, &block37, std::vector<compiler::Node*>{phi_bb34_17, phi_bb34_19});
  }

  TNode<Int32T> phi_bb36_17;
  TNode<IntPtrT> phi_bb36_19;
  TNode<Int32T> tmp32;
  if (block36.is_used()) {
    ca_.Bind(&block36, &phi_bb36_17, &phi_bb36_19);
    tmp32 = AllowNonNumberElements_0(state_, TNode<Int32T>{phi_bb36_17});
    ca_.Goto(&block37, tmp32, phi_bb36_19);
  }

  TNode<Int32T> phi_bb37_17;
  TNode<IntPtrT> phi_bb37_19;
  if (block37.is_used()) {
    ca_.Bind(&block37, &phi_bb37_17, &phi_bb37_19);
    ca_.Goto(&block35, phi_bb37_17, phi_bb37_19);
  }

  TNode<Int32T> phi_bb35_17;
  TNode<IntPtrT> phi_bb35_19;
  if (block35.is_used()) {
    ca_.Bind(&block35, &phi_bb35_17, &phi_bb35_19);
    ca_.Goto(&block27, phi_bb35_17, phi_bb35_19);
  }

  TNode<Int32T> phi_bb27_17;
  TNode<IntPtrT> phi_bb27_19;
  TNode<IntPtrT> tmp33;
  TNode<IntPtrT> tmp34;
  if (block27.is_used()) {
    ca_.Bind(&block27, &phi_bb27_17, &phi_bb27_19);
    tmp33 = FromConstexpr_intptr_constexpr_int31_0(state_, 1);
    tmp34 = CodeStubAssembler(state_).IntPtrAdd(TNode<IntPtrT>{phi_bb27_19}, TNode<IntPtrT>{tmp33});
    ca_.Goto(&block23, phi_bb27_17, tmp34);
  }

  TNode<Int32T> phi_bb22_17;
  TNode<IntPtrT> phi_bb22_19;
  TNode<BoolT> tmp35;
  if (block22.is_used()) {
    ca_.Bind(&block22, &phi_bb22_17, &phi_bb22_19);
    tmp35 = ElementsKindNotEqual_0(state_, TNode<Int32T>{phi_bb22_17}, TNode<Int32T>{tmp16});
    ca_.Branch(tmp35, &block38, std::vector<compiler::Node*>{phi_bb22_17}, &block39, std::vector<compiler::Node*>{phi_bb22_17});
  }

  TNode<Int32T> phi_bb38_17;
  TNode<Int32T> tmp36;
  TNode<Smi> tmp37;
  if (block38.is_used()) {
    ca_.Bind(&block38, &phi_bb38_17);
    tmp36 = Convert_int32_ElementsKind_0(state_, TNode<Int32T>{phi_bb38_17});
    ...
    ca_.Goto(&block39, phi_bb38_17);
  }

  TNode<Int32T> phi_bb39_17;
  TNode<IntPtrT> tmp38;
  TNode<Number> tmp39;
  TNode<Smi> tmp40;
  if (block39.is_used()) {
    ca_.Bind(&block39, &phi_bb39_17);
    ...
    ca_.Goto(&block40, phi_bb39_17);
    if (label41.is_used()) {
      ca_.Bind(&label41);
      ca_.Goto(&block41, phi_bb39_17);
    }
  }

  TNode<Int32T> phi_bb41_17;
  if (block41.is_used()) {
    ca_.Bind(&block41, &phi_bb41_17);
    ca_.Goto(&block1);
  }

  TNode<Int32T> phi_bb40_17;
  TNode<BoolT> tmp42;
  if (block40.is_used()) {
    ca_.Bind(&block40, &phi_bb40_17);
    tmp42 = CodeStubAssembler(state_).SmiNotEqual(TNode<Smi>{tmp0}, TNode<Smi>{tmp40});
    ca_.Branch(tmp42, &block42, std::vector<compiler::Node*>{phi_bb40_17}, &block43, std::vector<compiler::Node*>{phi_bb40_17});
  }

  TNode<Int32T> phi_bb42_17;
  if (block42.is_used()) {
    ca_.Bind(&block42, &phi_bb42_17);
    ca_.Goto(&block1);
  }

  TNode<Int32T> phi_bb43_17;
  TNode<JSArray> tmp43;
  TNode<Smi> tmp44;
  TNode<BoolT> tmp45;
  if (block43.is_used()) {
    ...
    ca_.Branch(tmp45, &block44, std::vector<compiler::Node*>{phi_bb43_17}, &block45, std::vector<compiler::Node*>{phi_bb43_17});
  }

  TNode<Int32T> phi_bb44_17;
  TNode<IntPtrT> tmp46;
  TNode<FixedArray> tmp47;
  TNode<IntPtrT> tmp48;
  TNode<Number> tmp49;
  if (block44.is_used()) {
    ca_.Bind(&block44, &phi_bb44_17);
    ...
    tmp49 = FromConstexpr_Number_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x0ull));
    CodeStubAssembler(state_).StoreReference<Number>(CodeStubAssembler::Reference{tmp8, tmp48}, tmp49);
    ca_.Goto(&block2);
  }

  TNode<Int32T> phi_bb45_17;
  TNode<BoolT> tmp50;
  if (block45.is_used()) {
    ca_.Bind(&block45, &phi_bb45_17);
    tmp50 = CodeStubAssembler(state_).IsFastSmiOrTaggedElementsKind(TNode<Int32T>{phi_bb45_17});
    ca_.Branch(tmp50, &block46, std::vector<compiler::Node*>{phi_bb45_17}, &block47, std::vector<compiler::Node*>{phi_bb45_17});
  }

  TNode<Int32T> phi_bb46_17;
  if (block46.is_used()) {
    ca_.Bind(&block46, &phi_bb46_17);
    FastSplice_FixedArray_JSAny_0(state_, TNode<Context>{p_context}, TorqueStructArguments{TNode<RawPtrT>{p_args.frame}, TNode<RawPtrT>{p_args.base}, TNode<IntPtrT>{p_args.length}, TNode<IntPtrT>{p_args.actual_count}}, TNode<JSArray>{tmp8}, TNode<Smi>{tmp40}, TNode<Smi>{tmp7}, TNode<Smi>{tmp2}, TNode<Smi>{p_insertCount}, TNode<Smi>{tmp4});
    ca_.Goto(&block48, phi_bb46_17);
  }

  TNode<Int32T> phi_bb47_17;
  if (block47.is_used()) {
    ca_.Bind(&block47, &phi_bb47_17);
    FastSplice_FixedDoubleArray_Number_0(state_, TNode<Context>{p_context}, TorqueStructArguments{TNode<RawPtrT>{p_args.frame}, TNode<RawPtrT>{p_args.base}, TNode<IntPtrT>{p_args.length}, TNode<IntPtrT>{p_args.actual_count}}, TNode<JSArray>{tmp8}, TNode<Smi>{tmp40}, TNode<Smi>{tmp7}, TNode<Smi>{tmp2}, TNode<Smi>{p_insertCount}, TNode<Smi>{tmp4});
    ca_.Goto(&block48, phi_bb47_17);
  }

  TNode<Int32T> phi_bb48_17;
  if (block48.is_used()) {
    ca_.Bind(&block48, &phi_bb48_17);
    ca_.Goto(&block2);
  }
...
void FastSplice_FixedArray_JSAny_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TorqueStructArguments p_args, TNode<JSArray> p_a, TNode<Smi> p_length, TNode<Smi> p_newLength, TNode<Smi> p_actualStart, TNode<Smi> p_insertCount, TNode<Smi> p_actualDeleteCount) {
  ...
  if (block14.is_used()) {
    ...
    tmp31 = FromConstexpr_intptr_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x2ull));
  ...
  TNode<BoolT> tmp32;
  if (block18.is_used()) {
    ca_.Bind(&block18, &phi_bb18_11, &phi_bb18_13);
    tmp32 = CodeStubAssembler(state_).IntPtrLessThan(TNode<IntPtrT>{phi_bb18_13}, TNode<IntPtrT>{p_args.length});
    ca_.Branch(tmp32, &block16, std::vector<compiler::Node*>{phi_bb18_11, phi_bb18_13}, &block17, std::vector<compiler::Node*>{phi_bb18_11, phi_bb18_13});
  }
  ...
  TNode<IntPtrT> tmp38;
  if (block16.is_used()) {
    ca_.Bind(&block16, &phi_bb16_11, &phi_bb16_13);
    tmp33 = CodeStubAssembler(state_).GetArgumentValue(TorqueStructArguments{TNode<RawPtrT>{p_args.frame}, TNode<RawPtrT>{p_args.base}, TNode<IntPtrT>{p_args.length}, TNode<IntPtrT>{p_args.actual_count}}, TNode<IntPtrT>{phi_bb16_13});
    tmp34 = FromConstexpr_Smi_constexpr_int31_0(state_, 1);
    tmp35 = CodeStubAssembler(state_).SmiAdd(TNode<Smi>{phi_bb16_11}, TNode<Smi>{tmp34});
    tmp36 = UnsafeCast_JSAny_0(state_, TNode<Context>{p_context}, TNode<Object>{tmp33});
    StoreFixedArrayDirect_0(state_, TNode<FixedArray>{tmp30}, TNode<Smi>{phi_bb16_11}, TNode<Object>{tmp36});
    tmp37 = FromConstexpr_intptr_constexpr_int31_0(state_, 1);
    tmp38 = CodeStubAssembler(state_).IntPtrAdd(TNode<IntPtrT>{phi_bb16_13}, TNode<IntPtrT>{tmp37});
  ...
  if (block17.is_used()) {
    ca_.Bind(&block17, &phi_bb17_11, &phi_bb17_13);
    ca_.Goto(&block15, phi_bb17_11);
  }
...
void FastSplice_FixedDoubleArray_Number_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TorqueStructArguments p_args, TNode<JSArray> p_a, TNode<Smi> p_length, TNode<Smi> p_newLength, TNode<Smi> p_actualStart, TNode<Smi> p_insertCount, TNode<Smi> p_actualDeleteCount) {
  ...
  if (block16.is_used()) {
    ...
    StoreFixedDoubleArrayDirect_0(state_, TNode<FixedDoubleArray>{tmp30}, TNode<Smi>{phi_bb16_11}, TNode<Number>{tmp36});
    tmp37 = FromConstexpr_intptr_constexpr_int31_0(state_, 1);
    tmp38 = CodeStubAssembler(state_).IntPtrAdd(TNode<IntPtrT>{phi_bb16_13}, TNode<IntPtrT>{tmp37});
    ca_.Goto(&block18, tmp35, tmp38);
  }
