...
const char* kBuiltinNameByteLength_0(compiler::CodeAssemblerState* state_) {
  ...
  compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ...
    ca_.Bind(&block0);
  return "DateView.prototype.byteLength";}
...
const char* kBuiltinNameByteOffset_0(compiler::CodeAssemblerState* state_) {
  ...
  compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ...
    ca_.Bind(&block0);
  return "DateView.prototype.byteOffset";}
...
TNode<Numeric> DataViewGet_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Object> p_receiver, TNode<Object> p_requestIndex, TNode<Object> p_requestedLittleEndian, ElementsKind p_kind) {
  ...
  if (block11.is_used()) {
    ...
    tmp11 = CodeStubAssembler(state_).LoadReference<UintPtrT>(CodeStubAssembler::Reference{tmp1, tmp10});
    tmp12 = FromConstexpr_intptr_constexpr_int31_0(state_, 48);
    tmp13 = CodeStubAssembler(state_).LoadReference<Uint32T>(CodeStubAssembler::Reference{tmp1, tmp12});
    tmp14 = ca_.UncheckedCast<BoolT>(CodeStubAssembler(state_).DecodeWord32<base::BitField<bool, 0, 1, uint32_t>>(ca_.UncheckedCast<Word32T>(tmp13)));
  ...
  if (block12.is_used()) {
    ...
    tmp16 = CodeStubAssembler(state_).LoadReference<JSArrayBuffer>(CodeStubAssembler::Reference{tmp1, tmp15});
    compiler::CodeAssemblerLabel label18(&ca_);
    tmp17 = CodeStubAssembler(state_).LoadVariableLengthJSArrayBufferViewByteLength(TNode<JSArrayBufferView>{tmp1}, TNode<JSArrayBuffer>{tmp16}, &label18);
    ca_.Goto(&block17);
    if (label18.is_used()) {
      ca_.Bind(&label18);
      ca_.Goto(&block18);
  ...
  if (block13.is_used()) {
    ...
    tmp20 = CodeStubAssembler(state_).LoadReference<UintPtrT>(CodeStubAssembler::Reference{tmp1, tmp19});
    ca_.Goto(&block14, tmp20);
  }
  ...
  if (block14.is_used()) {
    ...
    tmp21 = FromConstexpr_uintptr_constexpr_int31_0(state_, (DataViewBuiltinsAssembler(state_).DataViewElementSize(p_kind)));
    compiler::CodeAssemblerLabel label22(&ca_);
    CheckIntegerIndexAdditionOverflow_0(state_, TNode<UintPtrT>{tmp2}, TNode<UintPtrT>{tmp21}, TNode<UintPtrT>{phi_bb14_9}, &label22);
    ca_.Goto(&block19);
    if (label22.is_used()) {
      ca_.Bind(&label22);
      ca_.Goto(&block20);
  ...
  if (block19.is_used()) {
    ca_.Bind(&block19);
    tmp23 = CodeStubAssembler(state_).UintPtrAdd(TNode<UintPtrT>{tmp2}, TNode<UintPtrT>{tmp11});
    if (((CodeStubAssembler(state_).ElementsKindEqual(p_kind, ElementsKind::UINT8_ELEMENTS)))) {
      ca_.Goto(&block21);
    } else {
      ca_.Goto(&block22);
  ...
  if (block21.is_used()) {
    ca_.Bind(&block21);
    tmp24 = LoadDataView8_0(state_, TNode<JSArrayBuffer>{tmp6}, TNode<UintPtrT>{tmp23}, false);
  ...
  if (block24.is_used()) {
    ca_.Bind(&block24);
    tmp25 = LoadDataView8_0(state_, TNode<JSArrayBuffer>{tmp6}, TNode<UintPtrT>{tmp23}, true);
    ca_.Goto(&block1, tmp25);
  }
  ...
  if (block27.is_used()) {
    ca_.Bind(&block27);
    tmp26 = LoadDataView16_0(state_, TNode<JSArrayBuffer>{tmp6}, TNode<UintPtrT>{tmp23}, TNode<BoolT>{tmp4}, false);
  ...
  if (block30.is_used()) {
    ca_.Bind(&block30);
    tmp27 = LoadDataView16_0(state_, TNode<JSArrayBuffer>{tmp6}, TNode<UintPtrT>{tmp23}, TNode<BoolT>{tmp4}, true);
  ...
  if (block33.is_used()) {
    ca_.Bind(&block33);
    tmp28 = LoadDataView32_0(state_, TNode<JSArrayBuffer>{tmp6}, TNode<UintPtrT>{tmp23}, TNode<BoolT>{tmp4}, p_kind);
  ...
  if (block36.is_used()) {
    ca_.Bind(&block36);
    tmp29 = LoadDataView32_0(state_, TNode<JSArrayBuffer>{tmp6}, TNode<UintPtrT>{tmp23}, TNode<BoolT>{tmp4}, p_kind);
  ...
  if (block39.is_used()) {
    ca_.Bind(&block39);
    tmp30 = LoadDataView32_0(state_, TNode<JSArrayBuffer>{tmp6}, TNode<UintPtrT>{tmp23}, TNode<BoolT>{tmp4}, p_kind);
    ca_.Goto(&block1, tmp30);
  }
  ...
  if (block42.is_used()) {
    ca_.Bind(&block42);
    tmp31 = LoadDataViewFloat64_0(state_, TNode<JSArrayBuffer>{tmp6}, TNode<UintPtrT>{tmp23}, TNode<BoolT>{tmp4});
    ca_.Goto(&block1, tmp31);
  }
  ...
  if (block45.is_used()) {
    ca_.Bind(&block45);
    tmp32 = LoadDataViewBigInt_0(state_, TNode<Context>{p_context}, TNode<JSArrayBuffer>{tmp6}, TNode<UintPtrT>{tmp23}, TNode<BoolT>{tmp4}, false);
  ...
  if (block48.is_used()) {
    ca_.Bind(&block48);
    tmp33 = LoadDataViewBigInt_0(state_, TNode<Context>{p_context}, TNode<JSArrayBuffer>{tmp6}, TNode<UintPtrT>{tmp23}, TNode<BoolT>{tmp4}, true);
...
TNode<Object> DataViewSet_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Object> p_receiver, TNode<Object> p_requestIndex, TNode<Object> p_value, TNode<Object> p_requestedLittleEndian, ElementsKind p_kind) {
  ...
  if (block16.is_used()) {
    ...
    tmp15 = CodeStubAssembler(state_).LoadReference<UintPtrT>(CodeStubAssembler::Reference{tmp1, tmp14});
    tmp16 = FromConstexpr_intptr_constexpr_int31_0(state_, 48);
    tmp17 = CodeStubAssembler(state_).LoadReference<Uint32T>(CodeStubAssembler::Reference{tmp1, tmp16});
  ...
  if (block17.is_used()) {
    ...
    tmp20 = CodeStubAssembler(state_).LoadReference<JSArrayBuffer>(CodeStubAssembler::Reference{tmp1, tmp19});
    compiler::CodeAssemblerLabel label22(&ca_);
    tmp21 = CodeStubAssembler(state_).LoadVariableLengthJSArrayBufferViewByteLength(TNode<JSArrayBufferView>{tmp1}, TNode<JSArrayBuffer>{tmp20}, &label22);
    ca_.Goto(&block22);
    if (label22.is_used()) {
      ca_.Bind(&label22);
      ca_.Goto(&block23);
  ...
  if (block18.is_used()) {
    ...
    tmp24 = CodeStubAssembler(state_).LoadReference<UintPtrT>(CodeStubAssembler::Reference{tmp1, tmp23});
  ...
  if (block19.is_used()) {
    ...
    tmp25 = FromConstexpr_uintptr_constexpr_int31_0(state_, (DataViewBuiltinsAssembler(state_).DataViewElementSize(p_kind)));
    compiler::CodeAssemblerLabel label26(&ca_);
    CheckIntegerIndexAdditionOverflow_0(state_, TNode<UintPtrT>{tmp2}, TNode<UintPtrT>{tmp25}, TNode<UintPtrT>{phi_bb19_11}, &label26);
    ca_.Goto(&block24);
    if (label26.is_used()) {
      ca_.Bind(&label26);
      ca_.Goto(&block25);
  ...
  if (block24.is_used()) {
    ca_.Bind(&block24);
    tmp27 = CodeStubAssembler(state_).UintPtrAdd(TNode<UintPtrT>{tmp2}, TNode<UintPtrT>{tmp15});
    if ((((CodeStubAssembler(state_).ElementsKindEqual(p_kind, ElementsKind::BIGUINT64_ELEMENTS)) || (CodeStubAssembler(state_).ElementsKindEqual(p_kind, ElementsKind::BIGINT64_ELEMENTS))))) {
      ca_.Goto(&block26);
    } else {
      ca_.Goto(&block27);
  ...
  if (block26.is_used()) {
    ca_.Bind(&block26);
    tmp28 = TORQUE_CAST(TNode<Numeric>{phi_bb8_7});
    StoreDataViewBigInt_0(state_, TNode<JSArrayBuffer>{tmp8}, TNode<UintPtrT>{tmp27}, TNode<BigInt>{tmp28}, TNode<BoolT>{tmp6});
    ca_.Goto(&block28);
  }
  ...
  if (block27.is_used()) {
    ca_.Bind(&block27);
    tmp29 = TORQUE_CAST(TNode<Numeric>{phi_bb8_7});
    tmp30 = CodeStubAssembler(state_).ChangeNumberToFloat64(TNode<Number>{tmp29});
  ...
  if (block29.is_used()) {
    ca_.Bind(&block29);
    tmp31 = CodeStubAssembler(state_).TruncateFloat64ToWord32(TNode<Float64T>{tmp30});
    StoreDataView8_0(state_, TNode<JSArrayBuffer>{tmp8}, TNode<UintPtrT>{tmp27}, TNode<Uint32T>{tmp31});
    ca_.Goto(&block31);
  }
  ...
  if (block32.is_used()) {
    ca_.Bind(&block32);
    tmp32 = CodeStubAssembler(state_).TruncateFloat64ToWord32(TNode<Float64T>{tmp30});
    StoreDataView16_0(state_, TNode<JSArrayBuffer>{tmp8}, TNode<UintPtrT>{tmp27}, TNode<Uint32T>{tmp32}, TNode<BoolT>{tmp6});
    ca_.Goto(&block34);
  }
  ...
  if (block35.is_used()) {
    ca_.Bind(&block35);
    tmp33 = CodeStubAssembler(state_).TruncateFloat64ToWord32(TNode<Float64T>{tmp30});
    StoreDataView32_0(state_, TNode<JSArrayBuffer>{tmp8}, TNode<UintPtrT>{tmp27}, TNode<Uint32T>{tmp33}, TNode<BoolT>{tmp6});
    ca_.Goto(&block37);
  }
  ...
  if (block38.is_used()) {
    ca_.Bind(&block38);
    tmp34 = CodeStubAssembler(state_).TruncateFloat64ToFloat32(TNode<Float64T>{tmp30});
    tmp35 = CodeStubAssembler(state_).BitcastFloat32ToInt32(TNode<Float32T>{tmp34});
    StoreDataView32_0(state_, TNode<JSArrayBuffer>{tmp8}, TNode<UintPtrT>{tmp27}, TNode<Uint32T>{tmp35}, TNode<BoolT>{tmp6});
    ca_.Goto(&block40);
  }
  ...
  if (block41.is_used()) {
    ca_.Bind(&block41);
    tmp36 = CodeStubAssembler(state_).Float64ExtractLowWord32(TNode<Float64T>{tmp30});
    tmp37 = CodeStubAssembler(state_).Float64ExtractHighWord32(TNode<Float64T>{tmp30});
    StoreDataView64_0(state_, TNode<JSArrayBuffer>{tmp8}, TNode<UintPtrT>{tmp27}, TNode<Uint32T>{tmp36}, TNode<Uint32T>{tmp37}, TNode<BoolT>{tmp6});
    ca_.Goto(&block43);
  }
