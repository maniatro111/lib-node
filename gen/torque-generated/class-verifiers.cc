...
void TorqueGeneratedClassVerifiers::JSWrappedFunctionVerify(JSWrappedFunction o, Isolate* isolate) {
  ...
  CHECK(o.IsJSWrappedFunction(isolate));
  {
    ...
    CHECK(wrapped_target_function__value.IsCallableApiObject() || wrapped_target_function__value.IsCallableJSProxy() || wrapped_target_function__value.IsJSWrappedFunction() || wrapped_target_function__value.IsJSBoundFunction() || wrapped_target_function__value.IsJSFunction());
  }
  {
...
void TorqueGeneratedClassVerifiers::JSBoundFunctionVerify(JSBoundFunction o, Isolate* isolate) {
  ...
  CHECK(o.IsJSBoundFunction(isolate));
  {
    ...
    CHECK(bound_target_function__value.IsCallableApiObject() || bound_target_function__value.IsCallableJSProxy() || bound_target_function__value.IsJSWrappedFunction() || bound_target_function__value.IsJSBoundFunction() || bound_target_function__value.IsJSFunction());
  }
  {
...
void TorqueGeneratedClassVerifiers::ErrorStackDataVerify(ErrorStackData o, Isolate* isolate) {
  ...
  CHECK(o.IsErrorStackData(isolate));
  {
    ...
    CHECK(call_site_infos_or_formatted_stack__value.IsJSReceiver() || call_site_infos_or_formatted_stack__value.IsUndefined() || call_site_infos_or_formatted_stack__value.IsNull() || call_site_infos_or_formatted_stack__value.IsFalse() || call_site_infos_or_formatted_stack__value.IsTrue() || call_site_infos_or_formatted_stack__value.IsSymbol() || call_site_infos_or_formatted_stack__value.IsString() || call_site_infos_or_formatted_stack__value.IsBigInt() || call_site_infos_or_formatted_stack__value.IsHeapNumber() || call_site_infos_or_formatted_stack__value.IsSmi() || call_site_infos_or_formatted_stack__value.IsFixedArray());
  }
  {
...
void TorqueGeneratedClassVerifiers::JSFinalizationRegistryVerify(JSFinalizationRegistry o, Isolate* isolate) {
  ...
  }
  {
    ...
    CHECK(cleanup__value.IsCallableApiObject() || cleanup__value.IsCallableJSProxy() || cleanup__value.IsJSWrappedFunction() || cleanup__value.IsJSBoundFunction() || cleanup__value.IsJSFunction());
  }
  {
...
void TorqueGeneratedClassVerifiers::PromiseReactionVerify(PromiseReaction o, Isolate* isolate) {
  ...
  }
  {
    ...
    CHECK(reject_handler__value.IsUndefined() || reject_handler__value.IsCallableApiObject() || reject_handler__value.IsCallableJSProxy() || reject_handler__value.IsJSWrappedFunction() || reject_handler__value.IsJSBoundFunction() || reject_handler__value.IsJSFunction());
  }
  {
    Object fulfill_handler__value = TaggedField<Object>::load(o, 24);
    Object::VerifyPointer(isolate, fulfill_handler__value);
    CHECK(fulfill_handler__value.IsUndefined() || fulfill_handler__value.IsCallableApiObject() || fulfill_handler__value.IsCallableJSProxy() || fulfill_handler__value.IsJSWrappedFunction() || fulfill_handler__value.IsJSBoundFunction() || fulfill_handler__value.IsJSFunction());
  }
  {
...
void TorqueGeneratedClassVerifiers::PromiseReactionJobTaskVerify(PromiseReactionJobTask o, Isolate* isolate) {
  ...
  }
  {
    Object handler__value = TaggedField<Object>::load(o, 24);
    Object::VerifyPointer(isolate, handler__value);
    CHECK(handler__value.IsUndefined() || handler__value.IsCallableApiObject() || handler__value.IsCallableJSProxy() || handler__value.IsJSWrappedFunction() || handler__value.IsJSBoundFunction() || handler__value.IsJSFunction());
  }
  {
    Object promise_or_capability__value = TaggedField<Object>::load(o, 32);
    Object::VerifyPointer(isolate, promise_or_capability__value);
...
void TorqueGeneratedClassVerifiers::ScriptVerify(Script o, Isolate* isolate) {
  ...
  {
    Object script_or_modules__value = TaggedField<Object>::load(o, 128);
    Object::VerifyPointer(isolate, script_or_modules__value);
    CHECK(script_or_modules__value.IsArrayList());
  }
}
...
void TorqueGeneratedClassVerifiers::CachedTemplateObjectVerify(CachedTemplateObject o, Isolate* isolate) {
  o.StructVerify(isolate);
  CHECK(o.IsCachedTemplateObject(isolate));
  {
...
void TorqueGeneratedClassVerifiers::SortStateVerify(SortState o, Isolate* isolate) {
  ...
  }
  {
    ...
    CHECK(userCmpFn__value.IsUndefined() || userCmpFn__value.IsCallableApiObject() || userCmpFn__value.IsCallableJSProxy() || userCmpFn__value.IsJSWrappedFunction() || userCmpFn__value.IsJSBoundFunction() || userCmpFn__value.IsJSFunction());
  }
  {
...
void TorqueGeneratedClassVerifiers::WasmApiFunctionRefVerify(WasmApiFunctionRef o, Isolate* isolate) {
  ...
  {
    Object suspender__value = TaggedField<Object>::load(o, 32);
    Object::VerifyPointer(isolate, suspender__value);
    CHECK(suspender__value.IsUndefined() || suspender__value.IsWasmSuspenderObject());
  }
}
...
void TorqueGeneratedClassVerifiers::WasmExportedFunctionDataVerify(WasmExportedFunctionData o, Isolate* isolate) {
  ...
  {
    Object signature__value = TaggedField<Object>::load(o, 40);
    Object::VerifyPointer(isolate, signature__value);
  ...
  {
    Object suspender__value = TaggedField<Object>::load(o, 72);
    Object::VerifyPointer(isolate, suspender__value);
    CHECK(suspender__value.IsUndefined() || suspender__value.IsWasmSuspenderObject());
  }
}
void TorqueGeneratedClassVerifiers::WasmJSFunctionDataVerify(WasmJSFunctionData o, Isolate* isolate) {
  ...
  {
    Object serialized_return_count__value = TaggedField<Object>::load(o, 24);
    Object::VerifyPointer(isolate, serialized_return_count__value);
    CHECK(serialized_return_count__value.IsSmi());
  }
  {
    Object serialized_parameter_count__value = TaggedField<Object>::load(o, 32);
...
void TorqueGeneratedClassVerifiers::WasmCapiFunctionDataVerify(WasmCapiFunctionData o, Isolate* isolate) {
  ...
  {
    Object embedder_data__value = TaggedField<Object>::load(o, 24);
...
void TorqueGeneratedClassVerifiers::WasmOnFulfilledDataVerify(WasmOnFulfilledData o, Isolate* isolate) {
  CHECK(o.IsWasmOnFulfilledData(isolate));
  {
...
void TorqueGeneratedClassVerifiers::WasmContinuationObjectVerify(WasmContinuationObject o, Isolate* isolate) {
  ...
  {
    Object jmpbuf__value = TaggedField<Object>::load(o, 16);
    Object::VerifyPointer(isolate, jmpbuf__value);
    CHECK(jmpbuf__value.IsForeign());
  }
  {
    Object parent__value = TaggedField<Object>::load(o, 24);
    Object::VerifyPointer(isolate, parent__value);
...
void TorqueGeneratedClassVerifiers::WasmSuspenderObjectVerify(WasmSuspenderObject o, Isolate* isolate) {
  ...
  }
  {
    ...
    CHECK(resume__value.IsJSObject());
  }
  {
    Object state__value = TaggedField<Object>::load(o, 48);
